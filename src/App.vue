<template>
  <div :class="{ 'dark-theme': darkMode }">
    <div id="nav" :class="['navbar', { 'default-bg': isTransparent, transparent: !isTransparent, sticky: isSticky }]">
    ...
    <div>
      <router-view :dark="darkMode" :toggle-dark-mode="toggleDarkMode" />
...
:root {
  ...
  --gradient-backgroundColor: linear-gradient(-135deg, #567A93 0%, #e0e0e0 100%) !important;
  --split-backgroundColor: linear-gradient(135deg, #567A93 0%, #e0e0e0 100%) !important;
}
...
.dark-theme {
  ...
  --text-color: #0b192e;
  --block-backgroundColor: #ffffff;
  --gradient-backgroundColor: linear-gradient(-135deg, #1c2a3c 0%, #31495f 100%) !important;
  --split-backgroundColor: linear-gradient(135deg, #1c2a3c 0%, #31495f 100%);
}
...
h1 {
  font-size: var(--h1-font-size-laptop);
  /* Standard til laptop størrelse */
}
